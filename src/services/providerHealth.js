...
export function providerStatusStyle(status = "") {
  ...
  const colors = {
    ...
    "CONNECTED VIA CACHE": { bg: "rgba(34,197,94,0.18)", text: "#86efac" },
    "OPTIONAL UNAVAILABLE": { bg: "rgba(34,197,94,0.18)", text: "#86efac" },
    "COVERED BY SPORTSDATAIO": { bg: "rgba(34,197,94,0.18)", text: "#86efac" },
    "CONNECTED — NOT USED FOR CURRENT BOARD": { bg: "rgba(34,197,94,0.18)", text: "#86efac" },
    CACHED: { bg: "rgba(34,197,94,0.18)", text: "#86efac" },
    ...
    "MISSING API KEY": { bg: "rgba(239,68,68,0.15)", text: "#fca5a5" },
    "INVALID API KEY": { bg: "rgba(239,68,68,0.15)", text: "#fca5a5" },
    "NETWORK FAILURE": { bg: "rgba(239,68,68,0.15)", text: "#fca5a5" },
    "REQUIRED PROVIDER UNAVAILABLE": { bg: "rgba(239,68,68,0.15)", text: "#fca5a5" },
    "CACHE STALE": { bg: "rgba(234,179,8,0.18)", text: "#fde047" },
    "TEMPORARILY UNAVAILABLE": { bg: "rgba(234,179,8,0.18)", text: "#fde047" },
    "NO PROJECTIONS GENERATED": { bg: "rgba(234,179,8,0.18)", text: "#fde047" },
    "MISSING OPTIONAL DATA": { bg: "rgba(234,179,8,0.18)", text: "#fde047" },
